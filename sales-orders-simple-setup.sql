-- Sales Orders System Simple Setup
-- Execute this in Supabase SQL Editor for basic functionality
...
GRANT SELECT ON public.sales_order_line_items TO anon;
GRANT SELECT ON public.shipping_management TO anon;
