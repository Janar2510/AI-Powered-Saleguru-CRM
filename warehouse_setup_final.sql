-- Final Warehouse Setup Script
-- This script handles existing tables and constraints properly
...
-- Step 7: Create warehouse_movements table FOURTH
...
-- Step 9: Add check constraint to warehouse_movements if it doesn't exist
DO $$
BEGIN
...
-- Step 15: Insert warehouse products FIRST (with safe conflict handling)
...
-- Step 16: Insert warehouse locations SECOND (with safe conflict handling)
...
-- Step 17: Insert stock items for the products THIRD (no conflict handling needed)
...
-- Step 18: Insert sample movements FOURTH (no conflict handling needed)
