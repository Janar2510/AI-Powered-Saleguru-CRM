-- Document Builder System Setup for SaleToru CRM
...
-- Create RLS policies for documents (optimized with subquery)
...
-- Create RLS policies for branding (optimized with subquery)
...
-- Create RLS policies for AI generations (optimized with subquery)
...
-- Create RLS policies for document templates (optimized with subquery)
...
-- Create updated_at trigger function (fixed semicolon)
...
-- Create storage policies for branding bucket (fixed syntax)
