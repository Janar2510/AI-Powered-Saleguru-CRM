...
-- This script creates tables and inserts data without trying to delete from non-existent tables
...
-- Step 3: Create warehouse_stock table THIRD
...
-- Step 4: Create warehouse_movements table FOURTH
