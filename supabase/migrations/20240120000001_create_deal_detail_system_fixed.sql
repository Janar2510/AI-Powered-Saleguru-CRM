-- Enhanced Deal Detail System (FIXED VERSION)
...
CREATE TABLE IF NOT EXISTS deal_activities (
  ...
  created_by UUID NOT NULL, -- References your users table or auth.users
...
CREATE TABLE IF NOT EXISTS deal_files (
  ...
  uploaded_by UUID NOT NULL -- References your users table or auth.users
);
...
CREATE TABLE IF NOT EXISTS deal_changelog (
  ...
  changed_by UUID NOT NULL -- References your users table or auth.users
);
...
-- Note: Adjust these policies based on your specific deals table structure and user permissions
...
-- Success message
SELECT 'Deal Detail System migration completed successfully!' as message;
