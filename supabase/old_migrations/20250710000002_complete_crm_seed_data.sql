-- Complete CRM Seed Data Migration
-- This script creates realistic sample data for all CRM tables
-- Run this in your Supabase SQL editor to populate your CRM with working data
...
-- ============================================================================
-- 9. UPDATE USER POINTS BASED ON ACTIVITY
-- ============================================================================

-- Update user points based on their deals and activities
UPDATE users SET points = 1500 WHERE id = 1; -- Admin with high-value deals
UPDATE users SET points = 1200 WHERE id = 2; -- Manager with enterprise deals
UPDATE users SET points = 850 WHERE id = 3;  -- User with startup deals
UPDATE users SET points = 920 WHERE id = 4;  -- User with retail deals
UPDATE users SET points = 650 WHERE id = 5;  -- User with healthcare deals

-- ============================================================================
-- 10. VERIFICATION QUERIES (Optional - for checking data)
-- ============================================================================
...
-- 
-- Your CRM now has:
-- ✅ 5 Users (Admin, Manager, 3 Sales Reps)
-- ✅ 5 Companies (Tech, Manufacturing, Startup, Retail, Healthcare)
-- ✅ 7 Contacts (linked to companies)
-- ✅ 5 Leads (with AI insights)
-- ✅ 3 Pipelines (Default, Enterprise, Startup)
-- ✅ 15 Stages (across all pipelines)
-- ✅ 10 Deals (various stages and values)
-- ✅ 10 Tasks (various types and priorities)
-- 
