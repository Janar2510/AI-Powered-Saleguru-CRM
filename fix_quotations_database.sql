...
-- Insert sample quotations data (only if table is empty)
...
WHERE NOT EXISTS (SELECT 1 FROM quotations WHERE number = v.number);
...
-- Success message
SELECT 'Quotations database setup completed successfully!' as status; 