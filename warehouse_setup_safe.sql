-- Safe Warehouse Setup Script
-- This script handles existing tables and constraints gracefully

-- Step 1: Create warehouse_products table FIRST
...
-- Step 2: Add unique constraint to warehouse_products if it doesn't exist
DO $$
BEGIN
...
-- Step 3: Create warehouse_locations table SECOND
...
-- Step 4: Add unique constraint to warehouse_locations if it doesn't exist
DO $$
BEGIN
...
-- Step 5: Add check constraints if they don't exist
DO $$
BEGIN
...
-- Step 6: Create warehouse_stock table THIRD
...
-- Step 7: Add foreign key constraints to warehouse_stock if they don't exist
DO $$
BEGIN
...
-- Step 9: Add foreign key constraints to warehouse_movements if they don't exist
DO $$
BEGIN
...
-- Step 10: Add check constraint to warehouse_movements if it doesn't exist
DO $$
BEGIN
...
-- Step 11: Enable RLS for all tables
...
-- Step 12: Create RLS policies for warehouse_products
DO $$
BEGIN
...
-- Step 13: Create RLS policies for warehouse_locations
DO $$
BEGIN
...
-- Step 14: Create RLS policies for warehouse_stock
DO $$
BEGIN
...
-- Step 15: Create RLS policies for warehouse_movements
DO $$
BEGIN
...
-- Step 16: Insert warehouse products FIRST (with safe conflict handling)
...
-- Step 17: Insert warehouse locations SECOND (with safe conflict handling)
...
-- Step 18: Insert stock items for the products THIRD (no conflict handling needed)
...
-- Step 19: Insert sample movements FOURTH (no conflict handling needed)
