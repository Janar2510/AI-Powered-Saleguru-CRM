...
-- This script ensures all columns exist before adding constraints
...
-- Step 9: Add missing columns if they don't exist
DO $$
BEGIN
    -- Add product_id column to warehouse_stock if it doesn't exist
    ...
    -- Add location_id column to warehouse_stock if it doesn't exist
    ...
    -- Add product_id column to warehouse_movements if it doesn't exist
    ...
    -- Add from_location_id column to warehouse_movements if it doesn't exist
    ...
    -- Add to_location_id column to warehouse_movements if it doesn't exist
    ...
    -- Add reference column to warehouse_movements if it doesn't exist
    ...
    -- Add notes column to warehouse_movements if it doesn't exist
...
-- Step 15: Insert warehouse products FIRST
